...
// export default function Dashboard({ onCreate, onView, onDuplicate }: Props) {
...
//   // ===== EMPTY STATE — Matching Real Design =====
//   if (!loading && assignments.length === 0) {
//     return (
//       <div className="flex flex-col h-full bg-transparent">
//         <TopBar title="Assignment" onBack={() => {}} />
//         <div className="flex-1 flex flex-col items-center justify-center px-6" style={{ background: '#e8e8ec' }}>
//           {/* Illustration - use provided image, inline and natural */}
//           <img 
//             src="/assignment-empty.png" 
...
//           <p className="text-base text-gray-500 text-center max-w-[480px] mb-8 leading-relaxed">
//             Create your first assignment to start collecting and grading student submissions. You can set up rubrics, define marking criteria, and let AI assist with grading.
//           </p>
//           {/* Black button — matching real design */}
//           <button
//             onClick={onCreate}
//             className="flex items-center gap-2 px-6 py-3 bg-black text-white rounded-full font-semibold text-base shadow hover:bg-gray-900 transition-all"
//           >
...
//   // ===== FILLED STATE — Matching Figma Page 2 =====
//   return (
...
//             Assignments
//           </h1>
//           <p className="text-[13px] text-gray-500 mt-0.5 ml-4">
//             Manage and create assignments for your classes.
//           </p>
//         </div>

//         {/* Filter & Search — matching Figma */}
//         <div className="flex items-center gap-3 mb-5">
//           <button className="px-4 py-2 bg-white border border-gray-200 rounded-lg text-xs font-medium text-gray-600 hover:bg-gray-50 transition-all inline-flex items-center gap-1.5">
...
//                 <div
//                   key={assignment._id}
//                   className="bg-white border border-gray-200 rounded-xl p-5 hover:shadow-md transition-all cursor-pointer relative group"
//                   onClick={() => {
//                     if (assignment.status === "completed") onView(assignment._id);
//                   }}
//                 >
//                   {/* Three-dot menu */}
...
//                       <div className="absolute right-0 top-8 w-44 bg-white border border-gray-200 rounded-lg shadow-xl py-1 z-20">
//                         <button
//                           onClick={() => { onView(assignment._id); setMenuOpen(null); }}
//                           className="w-full text-left px-4 py-2 text-[13px] text-gray-800 hover:bg-gray-50 font-medium"
//                         >
//                           View Assignment
//                         </button>
//                         <button
//                           onClick={() => { setConfirmDelete(assignment._id); setMenuOpen(null); }}
//                           className="w-full text-left px-4 py-2 text-[13px] text-[#E8593C] hover:bg-red-50 font-medium"
//                         >
//                           Delete
//                         </button>
//                       </div>
...
//                   <h3 className="text-[15px] font-bold text-gray-900 mb-3 pr-8">
//                     {assignment.title}
//                   </h3>
...
//                       <Loader2 className="w-3 h-3 animate-spin text-[#E8593C]" />
//                       <span className="text-[11px] text-[#E8593C] font-medium">Generating...</span>
//                     </div>
//                   )}
//                 </div>
//               ))}
...
//               <button onClick={onCreate} className="btn-orange">
...
//               <X className="w-6 h-6 text-[#E8593C]" />
//             </div>
//             <h3 className="text-base font-bold text-gray-900 text-center mb-2">Delete Assignment?</h3>
...
//               <button onClick={() => handleDelete(confirmDelete)} className="flex-1 px-4 py-2.5 bg-[#E8593C] hover:bg-[#d44a2e] text-white font-medium rounded-lg text-sm transition-all text-center">Delete</button>
//             </div>
//           </div>
//         </div>
//       )}
